...
python3 fleetbench.py --config test.yaml # base_url: http://localhost:8099/v1
```
...
| key | default | meaning |
|---|---|---|
| `base_url` | — | OpenAI-compatible endpoint, e.g. `http://localhost:8080/v1` |
...
lm_eval --model local-chat-completions \
  ...
  --model_args model=GLM-5.2,base_url=http://localhost:8080/v1/chat/completions,num_concurrent=1,max_retries=3,tokenized_requests=False
```
