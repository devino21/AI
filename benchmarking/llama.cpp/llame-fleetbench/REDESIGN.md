...
Baseline for every number below: an archived four-model compact run
(glm-5.2, qwen3.6-27b-mtp-q8,
...
four models may discriminate for a weaker one — a separate weaker-model run
...
in an archived full-results pool (2920 rows, **9 models, 229 tasks**):
...
Not verified: a real run against llama-swap. The fleet was mid-run on a
separate model throughout this work, and llama-swap auto-swaps on the `model`
